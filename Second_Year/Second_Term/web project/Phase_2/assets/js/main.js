...
async function updateNavbar() {
    ...
    console.log('🔍 Found elements:', {
        userOnly: userOnlyElements.length,
        adminOnly: adminOnlyElements.length,
        loggedIn: loggedInElements.length,
        loggedOut: loggedOutElements.length
    });
    ...
    if (user) {
        ...
        if (user.is_company) {
            ...
            adminOnlyElements.forEach(el => {
                el.style.display = 'block';
                console.log('✅ Showing admin element:', el.textContent, el);
            });
            userOnlyElements.forEach(el => {
                el.style.display = 'none';
                console.log('❌ Hiding user element:', el.textContent, el);
            });
        } else {
            console.log('👨‍💼 Showing user menu');
            adminOnlyElements.forEach(el => {
                el.style.display = 'none';
                console.log('❌ Hiding admin element:', el.textContent, el);
            });
            userOnlyElements.forEach(el => {
                el.style.display = 'block';
                console.log('✅ Showing user element:', el.textContent, el);
            });
        }
    } else {
...
// Manual navbar refresh function for debugging
window.refreshNavbarNow = async function() {
    console.log('🔄 Manual navbar refresh triggered');
    await updateNavbar();
    console.log('✅ Manual navbar refresh completed');
};
